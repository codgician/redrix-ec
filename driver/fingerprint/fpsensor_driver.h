...
#ifndef PLATFORM_EC_DRIVER_FINGERPRINT_FPSENSOR_DRIVER_H_
#define PLATFORM_EC_DRIVER_FINGERPRINT_FPSENSOR_DRIVER_H_
...
#endif /* PLATFORM_EC_DRIVER_FINGERPRINT_FPSENSOR_DRIVER_H_ */
