...
#ifndef PLATFORM_EC_DRIVER_FINGERPRINT_FPC_FPC_MATCHER_H_
#define PLATFORM_EC_DRIVER_FINGERPRINT_FPC_FPC_MATCHER_H_
...
#endif /* PLATFORM_EC_DRIVER_FINGERPRINT_FPC_FPC_MATCHER_H_ */
