...
#ifndef PLATFORM_EC_DRIVER_FINGERPRINT_EGIS_PLATFORM_INC_PLAT_SPI_H_
#define PLATFORM_EC_DRIVER_FINGERPRINT_EGIS_PLATFORM_INC_PLAT_SPI_H_
...
#endif /* PLATFORM_EC_DRIVER_FINGERPRINT_EGIS_PLATFORM_INC_PLAT_SPI_H_ */
